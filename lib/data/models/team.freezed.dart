...
mixin _$Team {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, tournamentId, name, logoUrl);

  @override
  String toString() {
    return 'Team(id: $id, tournamentId: $tournamentId, name: $name, logoUrl: $logoUrl)';
  }
}
...
abstract mixin class $TeamCopyWith<$Res> {
  factory $TeamCopyWith(Team value, $Res Function(Team) _then) =
      _$TeamCopyWithImpl;
  @useResult
  $Res call({String id, String tournamentId, String name, String? logoUrl});
}
...
extension TeamPatterns on Team {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            String id, String tournamentId, String name, String? logoUrl)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Team() when $default != null:
        return $default(
            _that.id, _that.tournamentId, _that.name, _that.logoUrl);
      case _:
        return orElse();
    }
  }
